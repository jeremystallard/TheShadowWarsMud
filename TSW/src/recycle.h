...
/* room weave recycling */
#define RAD AFFECT_DATA
RAD *new_room_weave args( ( void) );
void free_room_weave args( (AFFECT_DATA *wd) );
#undef RAD

/* ward recycling */
#define WD WARD_DATA
WD *new_ward args( ( void) );
void free_ward args( (WARD_DATA *wd) );
#undef WD

/* residue recycling */
#define RD RESIDUE_DATA
RD *new_residue args( ( void) );
void free_residue args( (RESIDUE_DATA *rd) );
#undef RD
...
bool *		new_gknown	args( ( void ) );
void		free_gknown	args( ( bool * ) );
