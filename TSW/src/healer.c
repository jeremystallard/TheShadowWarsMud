...
void do_heal(CHAR_DATA *ch, char *argument)
{
	...
	send_to_char("  endurance:  restore endurance	      10 gold\n\r",ch);
    ...
    else if (!str_prefix(arg,"endurance") || !str_prefix(arg,"energize"))
    {
        spell = NULL;
        sn = -1;
        words = "energizer";
    ...
    if (spell == NULL)  /* restore endurance trap...kinda hackish */
    {
	ch->endurance += dice(2,8) + mob->level / 3;
	ch->endurance = UMIN(ch->endurance,ch->max_endurance);
