...
void	ssguildedit		args( ( CHAR_DATA *ch, char *argument ) );
...
extern const struct olc_cmd_type	ssguildedit_table[];
 ...
 */
DECLARE_OLC_FUN( ssguildedit_flags		);
DECLARE_OLC_FUN( ssguildedit_rank		);
DECLARE_OLC_FUN( ssguildedit_skill		);
DECLARE_OLC_FUN( ssguildedit_show		);
DECLARE_OLC_FUN( ssguildedit_name		);
DECLARE_OLC_FUN( ssguildedit_whoname		);
DECLARE_OLC_FUN( ssguildedit_create		);
DECLARE_OLC_FUN( ssguildedit_list		);
DECLARE_OLC_FUN( ssguildedit_rooms            );
DECLARE_OLC_FUN( ssguildedit_ml               );
