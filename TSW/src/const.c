...
const struct item_type		item_table	[]	=
{
    ...
    {   ITEM_AIRWALL,      "airwall" },
    {   ITEM_VEHICLE,      "vehicle" },
    {   ITEM_ORE,      	       "ore" },
    {   ITEM_GEMSTONE,    "gemstone" },
...
const   struct wiznet_type      wiznet_table    []              =
{
   ...
   { 	"channeling", 	WIZ_CHANNELING, IM },
   { 	"roleplay", 	WIZ_ROLEPLAY,   IM },
   { 	"minion", 	WIZ_MINION,     L3 },
   { 	"guild", 	WIZ_GUILD,      IM },
   { 	"subguild", 	WIZ_SUBGUILD,    IM },
   { 	"subsubguild", 	WIZ_SUBSUBGUILD, IM },
   {	NULL,		0,		0  }
};
...
const 	struct attack_type	attack_table	[MAX_DAMAGE_MESSAGE]	=
{
    ...
    { "elbow",	"elbow",	DAM_PIERCE	},  /* 40 */
    { "headbutt",	"headbutt",	DAM_BASH	},
    { "uppercut",	"uppercut",	DAM_PIERCE	},
    { "knee",		"knee",		DAM_BASH	},
    { "shoulderbash",	"shoulderbash",	DAM_BASH	},
    {   NULL,		NULL,		0		}   /* 45 */
};
...
*/
	...
	"giant",		TRUE,
	0,		0,		0,
	0,		RES_FIRE|RES_COLD,	VULN_WIND|VULN_LIGHTNING,
	A|H|M|V,	A|B|C|D|E|F|G|H|I|J|K
    },
	...
	"doll",			FALSE,
	0,		0,		0,
	IMM_COLD|IMM_POISON|IMM_HOLY|IMM_NEGATIVE|IMM_WIND|IMM_DISEASE
	...
	IMM_CHARM|IMM_DISEASE|IMM_WIND|IMM_HOLY|IMM_NEGATIVE,
 ...
 * Sphere table.
 */
const     struct    sphere_type    sphere_table   [] =
{
  { "air"   },
  { "earth"  },
  { "fire" },
...
{
    {
	"channeler", "Cha",  STAT_INT,  OBJ_VNUM_SCHOOL_SWORD,
	{ 3018, 9618 },  75,  8, 0,  8,  20, TRUE,
	"channeler basics", "channeler default"
    },

/*    {
	"cleric", "Cle",  STAT_WIS,  OBJ_VNUM_SCHOOL_STAFF,
...
char *	const			title_table	[MAX_CLASS][MAX_LEVEL+1][2] =
{
	...
	{ "Novice of Weaving",		"Novice of Weaving"		},
	{ "Saidin Student",		"Saidar Student"		},
	{ "Scholar of Saidin",		"Scholar of Saidar"		},
	{ "Delver in Saidin",		"Delveress in Saidar"		},
	{ "Saidin Supreme",		"Saidar Supreme"		},
...
/* Trains per level depends on wis_app */
...
const	struct	wis_app_type	wis_app_OLD		[31]		=
{
    { 0 },	/*  0 */
    { 0 },	/*  1 */
    { 0 },
...
/*    name			color	proof, full, thirst, food, ssize */
    ...
    { "oosquai",                "blue",         { 130, 1,  5, 0,  2 }   },
    { "apple cider",		"golden",	{   0, 1,  9, 2, 12 }	},
    { "kaf",			"black",	{   0, 1,  8, 0,  6 }	},
    { NULL,			NULL,		{   0, 0,  0, 0,  0 }	}
};
 ...
 */
	...
	{
	"bond",			{  12,  8, 17, 15 },     { 1,  1,  2,  2},
	spell_bond,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
	&gsn_bond,		SLOT( 4),	 5,	12,
	"",			"",	""
    },
    ...
    {
	"suffocate",		{ 17,  12, 15, 21 },     { 1,  1,  2,  2},
	spell_suffocate,	TAR_OBJ_CHAR_OFF,	POS_FIGHTING,
	&gsn_suffocate,		SLOT(33),	10,	12,
	"suffocate",		"You can breath again.",	
	""
    },
 ...
 */
   ...
   {
	"balefire",	{ 90, 40, 43, 46 },     { 1,  1,  2,  2},
	spell_balefire,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
...
/* combat and weapons skills */
	...
	{
	"bash door",			{ 53, 53, 53,  1 },	{ 0, 0, 0, 4},
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_bash_door,            	SLOT( 0),       0,      24,
        "bash",                 "!Bash Door!",		""
    },
	...
	{
	"butcher",		{ 53, 53, 53, 18 },	{ 0, 0, 0, 5},
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_butcher,        	SLOT( 0),       0,      24,
        "",                     "!Butcher!",	""
    },
    	{
	"camouflage",			{ 53, 53, 53,  1 },	{ 0, 0, 0, 4},
        spell_null,             TAR_IGNORE,             POS_STANDING,
	...
	{
        "blademaster",      { 45, 45, 45,  45 },     { 10, 9, 5, 3},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
        &gsn_blademaster,   SLOT( 0),        0,     0,
        "",                     "!BladeMaster!",	""
    },

    {
        "trollocwarfare",      { 45, 45, 45,  45 },     { 10, 9, 5, 3},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
        &gsn_trollocwarfare,   SLOT( 0),        0,     0,
        "",                     "!TrollocWarfare!",	""
    },
	...
	{	
	"herbs",		{ 25,  10, 15, 6 },	{ 8, 5, 6, 4},
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_herbs,	SLOT( 0),	0,	0,
	"",			"The herbs look more plentiful here.",	""
    },

	{	
	"fade",		{ 25,  10, 15, 6 },	{ 8, 5, 6, 4},
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_fade,	SLOT( 0),	0,	0,
	"fade",			"!fade!",	""
    },
    ...
    {
        "awareness",         { 10, 10, 10, 10 },     { 0, 0, 10, 4},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
    ...
    {
        "alertness",         { 10, 10, 10, 10 },     { 0, 0, 10, 4},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
        &gsn_alertness,      SLOT( 0),        0,     0,
        "",                     "!Alertness!",	""
    },

    {
        "observation",         { 10, 10, 10, 10 },     { 0, 0, 10, 4},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
        &gsn_observation,      SLOT( 0),        0,     0,
        "",                     "!Observation!",	""
    },


	{
        "push",         { 53, 53, 24, 12 },     { 0, 0, 10, 4},
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_push,      SLOT( 0),        0,     0,
        "push",                     "!Push!",	""
    },
...
/* non-combat skills */
    ...
    {
	"link",			{ 10, 10,  6, 20 },	{ 6, 6, 4, 8},
	spell_null,		TAR_IGNORE,		POS_RESTING,
	&gsn_link,		SLOT( 0),	0,	36,
	"",			"!Link!",		""
    },
	...
	"",			"!Recall!",		""
	    ...
	    {
	"ridding",		{  1,  1,  1,  1 },	{ 2, 2, 2, 2},
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_ridding,		SLOT( 0),	0,	12,
	"",			"!Ridding!",		""
    },
